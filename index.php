...
<body>
	...
	<div id="left-container"> 	    
        <div id="analog"><canvas id="canvas" width="350" height="350"></canvas></div>	  		
		<div id="jam"></div>
		<div id="tgl"></div>
		<div id="jadwal"></div>
	</div>	
    ...
    <script src="js/JamAnalog.js"></script>
    <script>
		...
		var app	={
			...
			showJadwal	: function(){
				...
				if($('.full-screen').is(":visible")){
					$('#full-screen-clock').html(jamSekarang.format("[<i class='fa fa-clock-o''></i>&nbsp;&nbsp;]HH:mm:ss"));
